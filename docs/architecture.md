...
| 4 | Setup wizard | `/mindframe:setup` | Claude-driven onboarding: discovers the environment, collects credentials, bootstraps the vault, wires triggers, runs a smoke test. **Redesigned 2026-06-02** into a web-app-first, dashboard-early, setup-as-a-mindframe flow — see [`onboarding-ux.md`](onboarding-ux.md) + [`install-flow-v2.md`](install-flow-v2.md). |
