...
frontmatter — one note per entity (Service, Repository, Runbook, Incident,
Team, …), a `CATALOG.md` index, and a `librarian` agent that maintains it.
...
The mindframe dashboard is a local web app (a Node/Express backend serving a
